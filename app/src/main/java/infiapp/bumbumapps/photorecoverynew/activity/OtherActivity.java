...
import infiapp.bumbumapps.photorecoverynew.model.OtherModel;
import infiapp.bumbumapps.photorecoverynew.R;
import infiapp.bumbumapps.photorecoverynew.adapter.OtherAdapter;
import infiapp.bumbumapps.photorecoverynew.task.RecoverOthersAsyncTask;

import static infiapp.bumbumapps.photorecoverynew.utills.Utils.mAlbumOthers;
            ...
            if (tempList.size() == 0) {
                ...
                mRecoverPhotosAsyncTask = new RecoverOthersAsyncTask(OtherActivity.this, adapter.getSelectedItem(), new RecoverOthersAsyncTask.OnRestoreListener() {
                    ...
                    public void onComplete() {
                        Toast.makeText(OtherActivity.this,tempList.size()+" Other file restored",Toast.LENGTH_LONG).show();
                        adapter.setAllImagesUnseleted();
                        adapter.notifyDataSetChanged();
                    }
                });
